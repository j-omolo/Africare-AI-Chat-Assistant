...
const ChatMessage = ({ message, isAi }) => {
  return (
    <div className={`max-w-7xl mx-auto flex items-start space-x-4 p-6 rounded-2xl transition-colors duration-200 ${isAi ? 'bg-blue-100' : 'bg-blue-50'}`}>
      ...
      <div className="flex-1 space-y-2">
        <div className="flex items-center">
          <p className={`font-medium ${isAi ? 'text-blue-900' : 'text-green-900'}`}>
            {isAi ? 'Africare AI Assistant' : 'You'}
          </p>
        </div>
